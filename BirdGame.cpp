...
void BirdGame::init()
{
    ...
    for(int i = 0; i < length; i++)
    {
        ...
        glm::vec2 s{
            spriteBottom.getSpriteSize().x / physicsScale,
            spriteBottom.getSpriteSize().y / physicsScale
        };


        phys = obj->addComponent<PhysicsComponent>();
        phys->initBox(b2_staticBody, s,
        {pos.x / physicsScale, pos.y / physicsScale}, 1);
    }
    ...
    for(int i = 0; i < length; i++)
    {
        ...
        glm::vec2 s{
            spriteTop.getSpriteSize().x / physicsScale,
            spriteTop.getSpriteSize().y / physicsScale
        };
    ...
    for(int i = 0; i < length; i++)
    {
        ...
        phys = obj->addComponent<PhysicsComponent>();
        phys->initCircle(b2_staticBody, spriteCoin.getSpriteSize().x / physicsScale / 2,
        {pos.x / physicsScale, pos.y / physicsScale}, 1);
